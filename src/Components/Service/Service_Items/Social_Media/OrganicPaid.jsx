  ...
  return (
    <div className="w-full">
      <div className="max-w-[1280px] mx-auto px-4 grid lg:grid-cols-2 grid-cols-1 -z-50 overflow-hidden">
        {/* Organic Container */}
        <div
          className="bg-slate-100 w-[90%] shadow-2xl py-10 px-10 rounded-3xl mx-auto lg:relative left-24 flex flex-col gap-10  justify-between items-center md:pr-10"
          data-aos="fade-left"
        ...
        {/* Paid Container */}
        <div
          className="bg-[#0c2d57] text-white w-[90%] py-10 shadow-xl rounded-3xl mx-auto z-20 flex flex-col gap-10 justify-between items-center"
          data-aos="fade-right"
          data-aos-duration="1000"
        >
