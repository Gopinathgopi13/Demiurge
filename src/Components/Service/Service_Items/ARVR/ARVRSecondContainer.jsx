      ...
      <div className="w-[95%] grid sm:grid-cols-2 mx-auto py-10 px-10 gap-5 shadow-lg rounded-xl ">
        ...
        <div className="space-y-5 flex flex-col justify-center md:px-5">
          ...
          <p>
            ...
            perferendis totam nostrum commodi? Recusandae, reprehenderit. Itaque
            iste molestiae culpa optio maxime voluptates esse officia
            dignissimos ipsum voluptatibus laborum beatae adipisci quaerat,
            possimus nulla eaque dolore vitae ex aperiam sint dolores molestias
            porro reiciendis veritatis. Voluptatum nam nemo ut perferendis
            repudiandae.
          </p>
        </div>
      </div>
