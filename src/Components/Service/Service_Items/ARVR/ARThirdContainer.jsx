...
function ARThirdContainer() {
  return (
    <div className="lg:w-[1280px] mx-auto px-4 lg:pb-20 h-[90vh]flex flex-col justify-center items-center text-center space-y-5 py-10">
      <div className="lg:text-4xl text-4xl lg:w-[90%] font-extrabold leading-snug">
        AR Application Development Technology Stack
      </div>
      <div className="text-xl lg:w-[90%] text-center leading-snug">
      ...
      <div className="grid md:grid-cols-5 gap-5">
        <div className="flex justify-center items-center shadow-xl rounded-3xl">
          <img src={ARTech1} className="h-[50%] w-[50%] object-contain" alt="" />
        </div>
        <div className="flex justify-center items-center shadow-xl rounded-3xl">
          <img src={ARTech2} className="h-[50%] w-[50%] object-contain" alt="" />
        </div>
        <div className="flex justify-center items-center shadow-xl rounded-3xl">
          <img src={ARTech3} className="h-[50%] w-[50%] object-contain" alt="" />
        </div>
        <div className="flex justify-center items-center shadow-xl rounded-3xl">
          <img src={ARTech4} className="h-[50%] w-[50%] object-contain" alt="" />
        </div>
        <div className="flex justify-center items-center shadow-xl rounded-3xl">
          <img src={ARTech5} className="h-[50%] w-[50%] object-contain" alt="" />
        </div>
      </div>
    </div>
  );
