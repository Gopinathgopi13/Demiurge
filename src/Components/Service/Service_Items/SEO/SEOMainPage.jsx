...
function SEOMainPage() {
  return (
    <div className="w-full">
      <div
        className="lg:w-[1280px] mx-auto px-4 lg:pb-20 h-[90vh] text-white flex flex-col lg:pt-40 lg:items-start items-center justify-center md:justify-between gap-y-5 relative"
        // data-aos="fade-down"
      ...
      >
        ...
        <div className="md:text-6xl text-[6vw] lg:w-[60%] font-extrabold leading-snug text-[#E48F45]">
