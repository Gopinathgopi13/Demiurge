...
function StartupFourthContainer() {
  return (
    <div className="lg:w-[1280px] sm:flex sm:flex-col sm:justify-center gap-10  mx-auto my-20 px-4 py-4">
      <div className="lg:text-5xl font-medium my-5">
        Your Startup Has the Power to Achieve Greatness
      </div>
      <div className="mx-auto w-[90%] border-2 border-black rounded-tl-3xl rounded-br-3xl space-y-10 py-10 px-5">
        ...
        <div className="sm:w-[30%] w-[50%]  overflow-hidden">
          <Link to="/contactForm">
            <div className="px-5 py-3 lg:text-2xl text-white  bg-[#0c2d57] flex items-center gap-4 cursor-pointer">
...
export default StartupFourthContainer;
