...
function RealEstateThirdContainer() {
  return (
    <div className="lg:w-[1280px] sm:flex sm:flex-col sm:justify-center gap-10  mx-auto my-20 px-4 py-4">
      <div className="lg:text-5xl font-medium my-5">
        Customized Real Estate Digital Marketing Strategies for Your Business
      </div>
      <div className="grid sm:grid-cols-2 mx-auto">
        ...
        <div className="flex flex-col justify-around text-justify px-2 gap-5">
          ...
          <Link to="/contactForm">
            <div className="px-16 py-5 text-2xl border-2 border-[#0c2d57] text-[#0c2d57] flex items-center gap-4 cursor-pointer">
...
export default RealEstateThirdContainer;
