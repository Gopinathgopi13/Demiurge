...
function EcommerceMainPage() {
  return (
    <div className="lg:w-[1280px] mx-auto px-4 lg:pb-20 h-[90vh] text-white flex flex-col justify-center items-start gap-y-14">
      ...
      <Link to="/contactForm">
        <div className="px-16 py-5 text-2xl text-[#e48f45] border-2 flex items-center gap-4 cursor-pointer">
