...
function SoftwareSecondContainer() {
  return (
    <div className="lg:w-[1280px] sm:flex sm:flex-col sm:justify-center  mx-auto px-10 py-10">
      <div className="lg:text-6xl font-medium my-5 py-5 text-[#e48f45]">
        Our Software Marketing Services
      </div>
...
export default SoftwareSecondContainer;
