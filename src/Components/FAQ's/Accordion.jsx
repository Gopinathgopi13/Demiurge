export default function Accordion(props) {
  return (
    ...
    // <div className="rounded-lg mb-5 overflow-hidden">
    //   <button
    //     className="w-full p-4 text-left flex md:px-28 justify-between items-center bg-gray-200 hover:bg-gray-300 transition duration-300"
    //     onClick={props.toggleAccordion}
    //   >
    //     <span className="font-semibold text-lg">{props.title}</span>
    //     <span
    ...
    //   </button>
    //   <div
    //     className={`py-4 md:px-10 px-5 text-md bg-gray-100 text-[#0C2D57] transition-height duration-300 `}
    //   >
    //     {props.data}
    //   </div>
    // </div>
